...
async function main() {
  ...
  console.log('[ava-daemon] endpoints: /health, /runtime/status, /input/classify, /input/dispatch, /code-agents/dispatch, /code-agents/sessions/start, /tasks/analyze, /tasks/plan, /mcp/servers, /chat/stream, /chat/ws')
