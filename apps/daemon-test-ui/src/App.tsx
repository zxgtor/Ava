...
function makeIntentGateTargets(baseUrl: string): TestTarget[] {
  ...
  return [
    ...
    {
      id: 'intent:creative-video-help',
      kind: 'intent',
      name: 'intent.creative_video_help',
      label: 'creative_video_help',
      description: 'Classify explicit short-video creation help as video_creation, not coding task intake.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
    ...
    {
      id: 'intent:creative-script-help',
      kind: 'intent',
      name: 'intent.creative_script_help',
      label: 'creative_script_help',
      description: 'Classify YouTube script help as chat/clarify, not project execution.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'Can you help me write a YouTube Shorts script about training a large language model?' },
        expectJson: {
          'result.route': 'video_creation',
          'result.workflow': 'video_creation',
          'result.requiresTaskIntake': false,
    ...
    },
    {
      ...
      label: 'video_explain_chat',
      description: 'Explaining video creation should stay chat unless the user asks Ava to create assets.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'Can you explain how video creation works?' },
        expectJson: {
          'result.route': 'normal_chat',
          'result.workflow': 'chat',
          'result.requiresTaskIntake': false,
    ...
    {
      id: 'intent:task-intake-react-path',
      kind: 'intent',
      name: 'intent.task_intake_react_path',
      label: 'task_intake_react_path',
      description: 'Still classify explicit app creation with a local path as task intake.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'Create a React app in D:\\Apps\\TestProject.' },
        expectJson: {
          'result.route': 'task_intake',
          'result.workflow': 'intake',
          'result.requiresTaskIntake': true,
    ...
    {
      id: 'intent:code-agent-meta-question',
      kind: 'intent',
      name: 'intent.code_agent_meta_question',
      label: 'code_agent_meta_question',
      description: 'Questions about whether Ava uses code agents should be chat, not actual delegation.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'When I ask Ava to complete a task, will Ava use code agent to complete it?' },
        expectJson: {
          'result.route': 'meta_question',
          'result.workflow': 'chat',
          'result.requiresTaskIntake': false,
...
function makeWorkflowDispatcherTargets(baseUrl: string): TestTarget[] {
  ...
  return [
    ...
    {
      id: 'workflow:creative-video-chat',
      kind: 'workflow',
      name: 'workflow.start_video_creation',
      label: 'start_video_creation',
      description: 'Dispatch explicit short-video creation help to the video_creation workflow.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'I want to create a short video about how to train large language model, can you help me with that?' },
        expectJson: {
          ...
          'result.workflow': 'video_creation',
          'result.actionPreview.requiresConfirmation': false,
          'result.actionPreview.workflowPreview.outputTarget': 'Chat Draft',
        },
      }),
    },
    {
      ...
      defaultRequest: requestJson({
        ...
        expectJson: {
          ...
          'result.workflow': 'video_creation',
          'result.actionPreview.requiresConfirmation': false,
          'result.actionPreview.workflowPreview.outputTarget': 'File Assets',
        },
      }),
    },
    {
      ...
      defaultRequest: requestJson({
        ...
        expectJson: {
          ...
          'result.workflow': 'video_creation',
          'result.actionPreview.requiresConfirmation': false,
          'result.actionPreview.workflowPreview.outputTarget': 'Remotion Project',
        },
      }),
    },
    {
    ...
    },
    {
      ...
      defaultRequest: requestJson({
        ...
        expectJson: {
          ...
          'result.workflow': 'video_creation',
          'result.actionPreview.requiresConfirmation': false,
          'result.actionPreview.workflowPreview.outputTarget': 'Prompt Pack Files',
        },
      }),
    },
    {
      ...
      defaultRequest: requestJson({
        ...
        expectJson: {
          ...
          'result.workflow': 'video_creation',
          'result.actionPreview.requiresConfirmation': false,
          'result.actionPreview.workflowPreview.outputTarget': 'Voiceover / SSML',
        },
      }),
    },
    {
      ...
      label: 'video_explain_chat',
      description: 'Dispatch video-creation explanation questions to chat, not the video workflow.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'Can you explain how video creation works?' },
        expectJson: {
          'result.classification.route': 'normal_chat',
          'result.action': 'run_chat',
          'result.workflow': 'chat',
        },
      }),
    ...
    {
      id: 'workflow:code-agent-meta-chat',
      kind: 'workflow',
      name: 'workflow.code_agent_meta_chat',
      label: 'code_agent_meta_chat',
      description: 'Dispatch code-agent behavior questions to chat instead of spawning a code agent.',
      defaultRequest: requestJson({
        method: 'POST',
        url,
        body: { content: 'When I ask Ava to complete a task, will Ava use code agent to complete it?' },
